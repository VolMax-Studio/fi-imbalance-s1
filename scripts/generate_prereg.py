...
Generates METHODOLOGY_PIN.md, PARAMS.md, and claims.json.
Note: SOURCE_POST.md is static and is NOT generated by this script.
"""
...
CLAIMS_DATA = [
  ...
  },
  {
    ...
    "claim_type": "RELATIONAL_IMPORT_MATCHING",
    "primary_dataset_se1": 378,
    "primary_dataset_se3": 379,
    "primary_dataset_need": 377,
    "primary_dataset_local": 375,
    "directional_condition": "DS_378 < 0 AND DS_379 < 0 (negative indicates cross-border import into FI)",
    "relational_formula": "abs(DS_378) + abs(DS_379) vs (DS_377 - DS_375)",
    "quantitative_boundary": "abs((abs(DS_378) + abs(DS_379)) - (DS_377 - DS_375)) <= 10.0 MW",
    "preregistered_status": "TESTABLE",
    "eval_branches": ["1.1", "1.2", "1.3", "1.4"]
  },
  {
  ...
  },
  {
    ...
    "preregistered_status": "TESTABLE",
    "eval_branches": ["2.1", "2.2", "2.3", "2.4"],
    "scope_limit": "Applies strictly to latest recorded forecast issue in DS 245; causal attribution ('partly responsible') is non-computational"
  },
  {
    "claim_id": "FI-06",
...
def generate_all():
    ...
    print("Successfully generated METHODOLOGY_PIN.md, PARAMS.md, claims.json in:", REPO_DIR)
